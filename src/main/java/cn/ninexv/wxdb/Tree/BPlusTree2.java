...
public class BPlusTree2<T, V extends Comparable<V>>{
    //B+树的阶
    ...
    //有参构造方法，可以设定B+树的阶
    public BPlusTree2(Integer bTreeOrder){
...
//            System.out.println("非叶子节点,插入key: " + node1.keys[node1.number - 1] + " " + node2.keys[node2.number - 1]);
            ...
            while(key.compareTo((V)this.keys[i]) != 0){
                System.out.println("下一次 "+key+" vs "+this.keys[i+1]);
                i++;
            }
